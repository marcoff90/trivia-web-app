      ...
      <>
          ...
          <div className={'home-page'}>
            ...
            <div className={'control'}>
              ...
              <div className={'modal'}>
                <InputModal
                    color={screenWidth >= 1024 ? 'rgba(49, 207, 160,0.49)'
                        : colors['main-orange']}
                    show={showLogin}
                    onClickOutside={() => {
                      toggleLoginModal()
                ...
                <InputModal
                  ...
                  <div className={'button-container'}>
                    <Button color={colors['main-red']}
                            onClick={() => AxiosService.forgottenPassword(
                                email)}
                            text={'Send Mail'}/>
                  </div>
              ...
              <div className={'modal'}>
                <InputModal
                  ...
                  <div className={'user-input'}>
                    <Input
                        borderColor={screenWidth >= 1024 ? colors['main-blue']
                            : colors['main-orange']}
                  ...
                  <div className={'password-input'}>
                    ...
                    <div className={'password-specifics'}>At least 8 characters,
                      1
                  ...
                  <div className={'button-container'}>
                    <Button color={screenWidth >= 1024 ? colors['main-blue']
                        : colors['main-orange']}
                            onClick={() => AxiosService.register(username,
                                email,
                                password)}
                            text={'Sign Up'}/>
                  </div>
